" dap: copied directly from
" https://github.com/Jorenar/dotfiles/blob/afefef864e73859078b6497dc1aa2f52fd3f514b/config/vim/pack/unused/opt/unused/autoload/lsp/call_hierarchy_tree.vim
" Note for my future self: toggle nodes in the tree with `o`.  See https://github.com/m-pilia/vim-yggdrasil?tab=readme-ov-file#settings
